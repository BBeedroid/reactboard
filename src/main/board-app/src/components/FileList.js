            ...
            {boardFileList && boardFileList.map(boardFile => (
                <div style={{
                    ...
                    <img style={{
                        ...
                        cursor: 'pointer'
                    }} className="fileImg" id={`img${boardFile.boardFileNo}`} src={`http://kr.object.ncloudstorage.com/bitcamp-bucket-126/board/${boardFile.boardFileName}`} onClick={() => openFileInput(boardFile.boardFileNo)}></img>
                    ...
                    <p style={{
                        display: 'inline-block', fontSize: '8px', cursor: 'pointer'
